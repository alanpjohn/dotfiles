    ...
    spec = {
        ...
        },
        {
            ...
            config = function()
                ...
                local function ensure_python_tools()
                    ...
                    if vim.fn.executable('uv') ~= 1 then return end

                    local tools = { 'pyrefly', 'ruff' }
                    for _, tool in ipairs(tools) do
                        local out = vim.fn.system('uv tool list')
                        if not string.find(out, '^' .. tool .. '$', 1, true) then
                            vim.fn.system('uv tool install ' .. tool)
                        end
                    end
                end
                        ...
                        settings = {
                            ...
                            languages = {
                                go = {
                                    ...
                                    { lintCommand = "golangci-lint run", lintDebounce = 500 },
                                },
                            },
                        },
                    },
        ...
        { -- Autoformat
            ...
            opts = {
                ...
                formatters_by_ft = {
                    lua = { 'stylua' },
                    -- go uses efm-langserver with goimports for LSP formatting
                    -- python = { 'ruff' },  -- Use LSP formatting instead
